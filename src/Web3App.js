...
function App() {
  ...
  const Address = "0x9A7346d4A07052Fce1581b7c1eE3894Dfe1645DB";
  ...
  const addition = async () => {
    let add = await contract.addition(num1, num2);
  };
  ...
  const count = async () => {
    ...
    setTotal(parseInt(total?._hex, 16));
  };
  ...
  return (
    <div className="App">
      <div className="joinChatContainer">
        ...
        />
        <button onClick={addition}>Add the Number</button>
